package SG.Poker.jwt;

import SG.Poker.member.dto.MemberResponseDto;
...
public class JwtTokenProvider {
    ...
    public MemberResponseDto.TokenInfo generateToken(String name, Collection<? extends GrantedAuthority> inputAuthorities) {
        ...
        String accessToken = Jwts.builder()
                ...
                .setExpiration(new Date(now.getTime() + accessTokenExpirationMinutes))  //토큰 만료 시간 설정
        ...
        String refreshToken = Jwts.builder()
                ...
                .setIssuedAt(now)   //토큰 발행 시간 정보
                .setExpiration(new Date(now.getTime() + refreshTokenExpirationMinutes)) //토큰 만료 시간 설정
                .signWith(key, SignatureAlgorithm.HS256)
                .compact();
